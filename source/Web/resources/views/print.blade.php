            ...
            <div class="invoice-print p-3">
                <div class="invoice-header d-flex justify-content-between flex-md-row flex-column pb-2">
                    <div>
                        <div class="d-flex mb-1">
                            ...
                            <h3 class="text-primary fw-bold ms-1">The Coffee</h3>
                        </div>
                    ...
                    <div class="mt-md-0 mt-2">
                        <h4 class="invoice-title">
                            Ordered At:
                            <span class="invoice-number">{{ $created_at }}</span>
                        </h4>
                    </div>
                </div>
                ...
                <div class="row pb-2">
                    <div class="col-sm-6">
                        ...
                        <p class="card-text mb-25">{{ $user['phone'] }}</p>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="fw-bold">{{ $fee['total'] }}</span></td>
                                </tr>
                                <tr>
                    ...
                    <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                        <div class="invoice-total-wrapper">
                            <div class="invoice-total-item">
                                <p class="invoice-total-title">Product price:</p>
                                <p class="invoice-total-amount">{{ $fee['product_price'] }}</p>
                            </div>
                            <div class="invoice-total-item">
                                <p class="invoice-total-title">Discount:</p>
                                <p class="invoice-total-amount">{{ $fee['discount'] }}</p>
                            </div>
                            <div class="invoice-total-item">
                                <p class="invoice-total-title">Ship:</p>
                                <p class="invoice-total-amount">{{ $fee['ship'] }}</p>
                            </div>
                            <hr class="my-50" />
                            <div class="invoice-total-item">
                                <p class="invoice-total-title">Total:</p>
                                <p class="invoice-total-amount">{{ $fee['total'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
